...
/**
* JPA动态条件查询类  使用方法：将查询条件封装成queryVirables对象，queryVirables格式如key=name_LIKE,value="sprout"
*
* @param <T> 持久化实体对象
*/
public class SproutSpecification<T> implements Specification<T> {

   private static final String SPLIT = "_";

   private Map<String, Object> queryParams;

   public SproutSpecification(Map<String, Object> queryParams) {
