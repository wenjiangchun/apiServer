package com.dlyy.api.common.util;
...
public class SproutDateUtils extends DateUtils {
	...
	public static final String DATE_TIME_PATTERN_1 = "yyyy-MM-dd'T'HH:mm:ss";

	public static final String DATE_TIME_PATTERN_2 = "yyyy-MM-dd'T'HH:mm:ss'Z'";
