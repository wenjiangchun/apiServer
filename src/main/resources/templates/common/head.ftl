...
<link rel="stylesheet"
      href="${ctx}/res/lib/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css">
...
<script src="${ctx}/res/lib/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
