                    ...
                    <form id="inputForm" class="form-horizontal" action="${ctx}/api/park/save" method="post">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="name" name="name" class="form-control" placeholder="请输入登录名" required/>
                                </div>
                                <label for="name" class="col-sm-2 control-label">车场编号</label>
                                <div class="col-sm-4">
                                    <input type="text" id="parkNo" name="parkNo"  class="form-control" placeholder="请输入车场编号" required/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="url" class="col-sm-2 control-label">URL</label>
                                <div class="col-sm-4">
                                    <input type="url" id="url" name="url" placeholder="请输入URL" class="form-control"/>
                                </div>
